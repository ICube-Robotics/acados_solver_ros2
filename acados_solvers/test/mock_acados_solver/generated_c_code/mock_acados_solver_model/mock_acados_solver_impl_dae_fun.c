...
/* mock_acados_solver_impl_dae_fun:(i0[4],i1[4],i2,i3[],i4[2])->(o0[4]) */
...
CASADI_SYMBOL_EXPORT int mock_acados_solver_impl_dae_fun(
...
CASADI_SYMBOL_EXPORT casadi_int mock_acados_solver_impl_dae_fun_n_in(void) {return 5;}
